...
public class StringSearchingStudentTests {
    ...
    public void testGenerateHash() {
        assertEquals(1457408186, StringSearching.generateHash(
                "matt is my friend", 4));
    }

    /**
     * PLEASE NOTE THAT THIS TEST DEPENDS ON GENERATE HASH WORKING PROPERLY
     */
    @Test(timeout = TIMEOUT)
    public void testUpdateHash() {
        StringSearching.generateHash("Default string with no bearing"
                + "on this method", 5);
        assertEquals(-565608696, StringSearching.updateHash(99342732, 5, 'a',
                'q'));
    }
